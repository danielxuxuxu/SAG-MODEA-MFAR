...
figures_dir = r'D:\SAG_MOEAD_exp_fig\SAG_MEAD_8.2\fig'
...
"""Parameters related to LEO"""
Num_LEO = 1
Height_LEO = 1000000
receive_rate_max = 100000000


# Define a class to describe IOT devices
class IOT:
...
# Define a class to describe UAVs
class UAV:
...
# Define a class to describe LEO
class LEO:
...
if __name__ == '__main__':
    ...
    save_to_file(Objective_PF_o, r'D:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.2\file\PF_o')
    ...
    save_to_file(IOT_capacity_population_A_PF_o,
                 r'D:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.2\file\IOT_capacity_population_A_PF_o')
    save_to_file(IOT_capacity_population_B_PF_o,
                 r'D:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.2\file\IOT_capacity_population_B_PF_o')
    ...
    init_adjust_rate = 1
    """--------------------------------Store the standard deviation of IOT capacity per epoch ----------------------------------"""
    ...
    for epoch in range(Evolution_epoch):
        ...
        for i in range(N):
            ...
            "The capacity list of IOT A and the capacity list of IOT B are updated according to the solution in the field of optimizing Chebyshev distance update"
        ...
        save_to_file(IOT_capacity_avg_dev_list_A,
                     r'D:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.2\file\IOT_capacity_avg_dev_list_A')
        ...
        save_to_file(IOT_capacity_avg_dev_list_B,
                     r'D:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.2\file\IOT_capacity_avg_dev_list_B')
        ...
        if epoch == Evolution_epoch - 1:
            save_to_file(EP, r'D:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.2\file\EP_final')
            save_to_file(FY, r'D:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.2\file\PF_final')
            save_to_file(EP_IOT_A_capacity_list,
                         r'D:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.2\file\EP_IOT_A_capacity_list_final')
            save_to_file(EP_IOT_B_capacity_list,
                         r'D:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.2\file\EP_IOT_B_capacity_list_final')
            ...
            EP_IOT_A_capacity_list_df.to_excel(
                r'D:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.2\file\EP_IOT_A_capacity_list_final.xlsx', engine='openpyxl')
            EP_IOT_B_capacity_list_df.to_excel(
                r'D:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.2\file\EP_IOT_B_capacity_list_final.xlsx', engine='openpyxl')
            save_to_file(HV_list, r'D:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.2\file\HV_list')
