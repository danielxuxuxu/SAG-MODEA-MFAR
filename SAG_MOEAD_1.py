...
'''图片保存的路径'''
figures_dir = r'E:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.5\fig'
...
def get_new_solution_new(i, Bi, last_solutions):
    ...
    parents1_idx = Bi[i][idx[0]]
    parents2_idx = Bi[i][idx[1]]
...
if __name__ == '__main__':
    ...
    """-----------------------------------Data from an individual in the initial population is plotted-------------------------------------"""
    ...
    """---------------------------------Plot the target values of the initialized N individuals--------------------------------"""
    ...
    """---------------------------------Obtain the initial pareto EP and plot the scatter plot--------------------------------"""
    ...
    save_to_file(Objective_PF_o, r'E:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.5\file\PF_o')
    ...
    save_to_file(IOT_capacity_population_A_PF_o,
                 r'E:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.5\file\IOT_capacity_population_A_PF_o')
    save_to_file(IOT_capacity_population_B_PF_o,
                 r'E:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.5\file\IOT_capacity_population_B_PF_o')
    ...
    """---------------------------------The reference point z for the initial population is obtained---------------------------------------"""
    ...
    """----------------------------------------Initialize the adjustment amount step---------------------------------------------"""
    init_adjust_rate = 1
    ...
    for epoch in range(Evolution_epoch):
        ...
        print("the number of eps in this round is", len(EP))
        ...
        save_to_file(IOT_capacity_avg_dev_list_A,
                     r'E:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.5\file\IOT_capacity_avg_dev_list_A')
        ...
        save_to_file(IOT_capacity_avg_dev_list_B,
                     r'E:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.5\file\IOT_capacity_avg_dev_list_B')
        ...
        if epoch == Evolution_epoch - 1:
            ...
            save_to_file(EP, r'E:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.5\file\EP_final')
            
            save_to_file(FY, r'E:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.5\file\PF_final')
            
            save_to_file(EP_IOT_A_capacity_list,
                         r'E:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.5\file\EP_IOT_A_capacity_list_final')
            save_to_file(EP_IOT_B_capacity_list,
                         r'E:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.5\file\EP_IOT_B_capacity_list_final')
            ...
            EP_IOT_A_capacity_list_df.to_excel(
                r'E:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.5\file\EP_IOT_A_capacity_list_final.xlsx', engine='openpyxl')
            EP_IOT_B_capacity_list_df.to_excel(
                r'E:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.5\file\EP_IOT_B_capacity_list_final.xlsx', engine='openpyxl')
            save_to_file(HV_list, r'E:\SAG_MOEAD_exp_fig\SAG_MOEAD_8.5\file\HV_list')
